package org.sf.jini.examples.blitzhelloworld;
...
class Lookup implements DiscoveryListener {
    ...
    /**
       ...
       @return proxy for the service type you requested - could be an remote
    ...
    /**
       ...
       proxy has been returned from locate().
     */
    void terminate() {
        synchronized(this) {
            if (theDiscoverer != null)
    ...
    /**
       Caller of locate ends up here, blocked until we find a proxy.
